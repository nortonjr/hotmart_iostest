...
class MessagesCoordinator: Coordinator {
    ...
    fileprivate lazy var baseViewController: UINavigationController? = {
        R.storyboard.messages.instantiateInitialViewController()
    }()
    ...
    func start() {
        ...
        let messageViewController = R.storyboard.messages.messagesViewController()!
        messageViewController.viewModel = RecentMessagesViewModel()
        navigationController.viewControllers = [messageViewController]
